          ...
          <Stack.Navigator
            ...
            >
            {
              (loggedinUser===null) ? <Stack.Screen name='Setup' component={LoginRegistrationStackScreen}/> //return login screen if user is null {}
                                      : (loggedinUser?.role === 'CUSTOMER') ? <Stack.Screen name="CustomerScreen" component={CustomerTabScreen} /> //return customer screens
                                                                          : <Stack.Screen name="MessOwnerScreen" component={MessOwnerTabScreen} />  //return owner screens
            }
          </Stack.Navigator>
