                        ...
                        (number===2) ? (
                            <>
                                <FormItem
                                    ...
                                    onChangeText={(i) => setMessDetails({...messDetails,firstname:i})}
                                    asterik
                                    ref={messInput}
                                />
                                <FormItem
                                    ...
                                    onChangeText={(i) => setMessDetails({...messDetails,lastname:i})}
                                    asterik
                                    ref={messInput}
                                />
                                <FormItem
                                    ...
                                    onChangeText={(i) => setMessDetails({...messDetails,phone:i})}
                                    asterik
                                    ref={messInput}
                                />
                                <FormItem
                                    ...
                                    onChangeText={(i) => setMessDetails({...messDetails,messname:i})}
                                    asterik
                                    ref={messInput}
                                />
                                <FormItem
                                    ...
                                    onChangeText={(i) => setMessDetails({...messDetails,pricing:i})}
                                    asterik
                                    ref={messInput}
                                />
                                <FormItem
                                    ...
                                    onChangeText={(i) => setMessDetails({...messDetails,address:i})}
                                    asterik
                                    ref={messInput}
                                />
                                <Picker
                                    ...
                                    onSelection={(i) => setMessDetails({...messDetails,service:i.value})}
                                    isRequired
                                    asterik
                                />
                                <Picker
                                    ...
                                    onSelection={(i) => setMessDetails({...messDetails,type:i.value})}
                                    isRequired
                                    asterik
                                />
                                <Picker
                                ...
                                <Picker
                                    ...
                                    onSelection={(item) => setMessDetails({...messDetails,trial:item.value})}
                                    isRequired
                                    asterik
                                />
                            </>
                            ...
                            <>
                                <FormItem
                                    ...
                                    onChangeText={  (firstname) => setCustomerDetails({...customerDetails, firstname:firstname})    }
                                    asterik
                                    ref={customerInput}
                                />
                                <FormItem
                                    ...
                                    onChangeText={(lastname) => setCustomerDetails({...customerDetails, lastname:lastname})}
                                    asterik
                                    ref={customerInput}
                                />
                                <FormItem
                                    ...
                                    onChangeText={(email) => setCustomerDetails({...customerDetails, email:email})}
                                    asterik
                                    ref={customerInput}
                                />
                                <FormItem
                                    ...
                                    onChangeText={(contact) => setCustomerDetails({...customerDetails, phone:contact})}
                                    asterik
                                    ref={customerInput}
                                />
                            </>
