  ...
  return (
    <View className="h-full">
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
          {
            newMessList?.filter(mess => {
              if (searchQuery === '') {
                return mess;
              } else if (mess?.messname.toLowerCase().includes(searchQuery.toLowerCase())) {
                return mess;
              }
              else if (mess?.type.toLowerCase().includes(searchQuery.toLowerCase())) {
                return mess;
              }
              ...
              return(
                ...
                <Card>
                  <Card.Content>
                    <Text className='capitalize' variant='titleMedium'>{messDetails?.messname}</Text>
                    <Text variant="bodyMedium"><Icon name='fastfood'/> {messDetails?.type}</Text>
                    <Text variant="bodyMedium"><Icon name='attach-money'/> {messDetails?.pricing}/month</Text>
                    <Text variant="bodyMedium" 
                      onPress={() => {openDialer(messDetails?.phone)}}
                    ><Icon name='phone'/> {messDetails?.phone}</Text>
                  </Card.Content>
